 ...
 *
 * The per-variable element-wise squares (z^v)^2 are computed once into a
 * private scratch buffer (R_Calloc, freed before return).
 * ------------------------------------------------------------------ */
void compute_localmultigeary(int n, int num_vars, const int *row_ptr, const int *col_idx, const double *weights, double **z, const int *undef, double *geary_out, int *cluster_out, int n_threads)
{
 ...
 *
 * The per-variable element-wise squares (z^v)^2 are computed once into a
 * private scratch buffer (R_Calloc), freed before returning and before error().
 * ------------------------------------------------------------------ */
